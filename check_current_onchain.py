...
bal_wallet = c.functions.balanceOf(wallet).call() / 1e6
bal_vault = c.functions.balanceOf(vault).call() / 1e6

print(f"USDC in Wallet: ${bal_wallet}")
print(f"USDC in Aerodrome Vault: ${bal_vault}")
print(f"Total Combined: ${bal_wallet + bal_vault}")
